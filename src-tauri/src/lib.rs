...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tray::ticker::set_tray_tooltip,
            tray::ticker::set_tray_title,
            tray::icons::set_tray_icon,
            tray::icons::set_tray_icon_size,
            tray::icons::set_tray_icon_shape,
            tray::icons::set_tray_colors,
            tray::popup::set_popup_vibrancy,
            tray::popup::set_popup_size,
            tray::popup::set_popup_zoom,
            tray::popup::set_popup_corner_radius,
            tray::menu::update_tray_menu,
            tray::menu::set_tray_click_actions,
            tray::popup::set_display_mode,
            tray::popup::set_always_on_top,
            tray::ticker::start_tray_ticker,
            tray::ticker::stop_tray_ticker,
            tray::popup::list_monitors,
            tray::popup::set_popup_monitor,
            tray::actions::open_kimai_in_browser,
